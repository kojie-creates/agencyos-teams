...
```text
Make AgencyOS Pro agents available to AgencyOS Being Custom as installable Skills.
```
...
| Truth Agent | Verification | Verifies artifacts, evidence, owners, hashes, and closeout labels before closure. |
...
| Coordinator | Best Personality |
| --- | --- |
| Research Coordinator | Evidence Mentor |
| Engineering Coordinator | Builder Copilot |
| Growth Coordinator | Creative Muse |
| Operations Coordinator | Mission Control |
| Insights Coordinator | Tactical Analyst |
...
Audit
Truth Agent
Evidence Lock / Hash Verification
```

Specialist personality alignment lives in:
